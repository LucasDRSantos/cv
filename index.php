...
<html lang="en-US">
  ...
  <body id="top">
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link smooth-scroll" href="http://localhost/cv/admin/about.php">Atualizar</a></li>
    ...
    <?php  
    $sql = "SELECT * FROM cv.cv_fundo WHERE id_fundo=1";
    try{
        $connect = open_coon();
        $result_2 = $connect ->query($sql);
        $fundo=$result_2->fetch_assoc();
        $connect = close_coon();
        }catch(Exception $e){
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small" filter-color="green">
      <div class="page-header-image" data-parallax="true" style="background-image: url('images/<?php echo($fundo['arquivo1'])?>"></div>
      <div class="container">
    <?php  
    $sql = "SELECT * FROM cv.cv_foto WHERE id_foto=1";
    try{
        $connect = open_coon();
        $result_1  = $connect ->query($sql);
        $foto=$result_1->fetch_assoc();
        $connect = close_coon();
        }catch(Exception $e){          
      } 
    ?>    
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/<?php echo($foto['arquivo'])?>" alt="Image"/></a></div>
          <div class="h2 title">Lucas do Rosario dos Santos</div>
      ...
      <div class="section">
        <div class="container">
          ...
          <a class="btn btn-default btn-round btn-lg btn-icon"  href="https://pt-br.facebook.com/" rel="tooltip" title="Follow me on Facebook"><i class="fa fa-facebook"></i></a>
          <a class="btn btn-default btn-round btn-lg btn-icon" href="https://twitter.com/" rel="tooltip" title="Follow me on Twitter"><i class="fa fa-twitter"></i></a>
          <a class="btn btn-default btn-round btn-lg btn-icon" href="https://mail.google.com/" rel="tooltip" title="Follow me on Google+"><i class="fa fa-google-plus"></i></a>
          <a class="btn btn-default btn-round btn-lg btn-icon"  href="https://www.instagram.com/lucas_1474/" rel="tooltip" title="Follow me on Instagram"><i class="fa fa-instagram"></i></a>
        </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
           ...
           <?php
             $sql="SELECT * FROM cv.cv_sobre  WHERE id=1";
             try{
                 $connect = open_coon();
  ...
  <div class="container">
    ...
    <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge"><?php echo($row['skil1']);?></span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo($row['porc1']);?>%"></div><span class="progress-value"><?php echo($row['porc1']);?>%</span>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge"><?php echo($row['skil2']);?></span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo($row['porc2']);?>%"></div><span class="progress-value"><?php echo($row['porc2']);?></span>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge"><?php echo($row['skil3']);?></span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo($row['porc3']);?>%"></div><span class="progress-value"><?php echo($row['porc3']);?>%</span>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge"><?php echo($row['skil4']);?></span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo($row['porc4']);?>%;"></div><span class="progress-value"><?php echo($row['porc4']);?>%</span>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <!-- <div class="col-md-6"> -->
            <!-- <div class="progress-container progress-primary"><span class="progress-badge">CANVAS</span>
              <div class="progress">
...
<?php  
//portifolio
    $sql = "SELECT * FROM cv.cv_porti WHERE id_porti=1"; 
    try{
        $connect = open_coon();
        $result_3  = $connect ->query($sql);
        $porti=$result_3->fetch_assoc();
        $connect = close_coon();
        }catch(Exception $e){          
      } 
    ?>    
          ...
          <div class="row">
            <div class="col-md-6">   
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="images/<?php echo($porti['arquivo_porti']);?>" alt="Image"/>
                    <figcaption>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <div class="h5"> <?php echo($row['data_matric']);?></div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
           <?php  echo($row['formacao']);?> 
          </div>
        </div>
      </div>
    </div>  
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png')">
    ...
    <footer class="footer">
      <div class="container text-center"><a class="cc-facebook btn btn-link" href="#"><i class="fa fa-facebook fa-2x " aria-hidden="true"></i></a><a class="cc-twitter btn btn-link " href="#"><i class="fa fa-twitter fa-2x " aria-hidden="true"></i></a><a class="cc-google-plus btn btn-link" href="#"><i class="fa fa-google-plus fa-2x" aria-hidden="true"></i></a><a class="cc-instagram btn btn-link" href="/https://www.instagram.com/"><i class="fa fa-instagram fa-2x " aria-hidden="true"></i></a></div>
